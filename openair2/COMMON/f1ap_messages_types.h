 ...
 */
 ...
 /* LTMConfigurationIDMapping-Item: lTMCellID NRCGI, lTMConfigurationID (1..8) */
 #define F1AP_MAX_NO_LTM_CONFIG_ID_MAPPING 8
 typedef struct f1ap_LTMConfigurationIDMapping_Item_s {
   plmn_id_t lTMCellID_plmn;
   uint64_t lTMCellID_nr_cellid;
   uint8_t lTMConfigurationID; /* 1..8 */
 } f1ap_LTMConfigurationIDMapping_Item_t;
 
 typedef struct f1ap_LTMConfigurationIDMappingList_s {
   int list_count;
...
typedef struct f1ap_EarlySyncInformation_Request_s {
  int requestforRACHConfiguration; /* RequestforRACHConfiguration ::= ENUMERATED {true}; 1 = true (mandatory) */
 ...
 typedef struct f1ap_ue_context_setup_req_s {
   ...
   /* Optional IEs for Inter-gNB-DU LTM Handover (TS 38.401 8.2.1.5, TS 38.473 9.2.2.1) */
   f1ap_LTMInformation_Setup_t *LTMInformation_Setup;       /* id-LTMInformation-Setup */
 ...
 /* UE Context Setup Response optional IEs for Inter-gNB-DU LTM Handover (TS 38.401 8.2.1.5, TS 38.473 9.2.2.2) */
 /* requestedTargetCellGlobalID: NRCGI (id-requestedTargetCellGlobalID) */
 typedef struct f1ap_requestedTargetCellGlobalID_s {
   plmn_id_t pLMN_Identity;
   uint64_t nRCellIdentity;
 } f1ap_requestedTargetCellGlobalID_t;
 
/* EarlySyncInformation: tCIStatesConfigurationsList (F1AP OCTET STRING), earlyULSyncConfig optional */
typedef struct f1ap_EarlySyncInformation_s {
  byte_array_t tCIStatesConfigurationsList; /* mandatory when EarlySyncInformation is present */
 ...
 typedef struct f1ap_ue_context_setup_resp_s {
   ...
   /* Optional IEs for Inter-gNB-DU LTM Handover (TS 38.401 8.2.1.5, TS 38.473 9.2.2.2) */
   f1ap_requestedTargetCellGlobalID_t *requestedTargetCellGlobalID; /* id-requestedTargetCellGlobalID NRCGI */
   f1ap_EarlySyncInformation_t *EarlySyncInformation;                /* id-EarlySyncInformation */
